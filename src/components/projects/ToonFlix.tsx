    ...
    <Panel>
      ...
      <PanelDescriptionContainer>
        <PanelDescriptionRow>
          ...
          <PanelDescriptionText>
            {info.project.ToonFlix.name}
          </PanelDescriptionText>
        </PanelDescriptionRow>
        <PanelDescriptionRow>
          <PanelDescriptionLabel>Link</PanelDescriptionLabel>
          <LinkLabel href={info.project.ToonFlix.link}>
            <span>
        ...
        <PanelDescriptionRow>
          ...
          <PanelDescriptionText>
            {info.project.ToonFlix.stack.map((value, idx) =>
              idx === info.project.ToonFlix.stack.length - 1
                ? value
                : value + ', '
            )}
          </PanelDescriptionText>
